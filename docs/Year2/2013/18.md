...
**Composite Objects** - Each component has a different role to play in composite(responsible for parts). Provides services to composite, but dont know about it. Composite collaborations with its components 
